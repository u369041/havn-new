  ...
  const demos = [
    {
      ...
      description:
        "Spacious home in Beaufort, minutes to Killarney. Open-plan kitchen/living, landscaped garden, and off-street parking."
    },
    {
      ...
      description:
        "Well-kept family home close to UHL, Crescent SC, and the M20. Ideal first-time buy or trade-up."
    },
    {
